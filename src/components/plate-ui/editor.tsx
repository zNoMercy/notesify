...
import { configuredProvidersAtom, selectedModelsAtom } from "@/atoms/setting/providers";
...
export const EditorContainer = ({
  ...
  const providerSettings = useAtomValue(configuredProvidersAtom);
  ...
  }, [providerSettings, selectedModels]);
